...
let virtual-env = "C:\Program Files\Python Projects\MP_analytics\.venv"
let bin = "Scripts"
let path-sep = ";"
...
let virtual_prompt = (if ("MP_analytics" != "") {
    "(MP_analytics) "
} {
...
alias deactivate = source "C:\Program Files\Python Projects\MP_analytics\.venv\Scripts\deactivate.nu"
