...
async def _post_fetch(session, url, id, body, params=None, headers=None, content_type='text'):
    while (True):
        try:
...
async def _fetch_all_tasks_by_urls(http_method, session, url_list, ids, params=None, body=None, headers=None, content_type='text'):
    tasks = list()
...
async def _fetch_all_tasks_by_params(http_method, session, url, params_list, ids, body=None, headers=None, content_type='text'):
    tasks = list()
...
async def _fetch_all_tasks_by_headers(http_method, session, url, headers_list, ids, params=None, body=None, content_type='text'):
    tasks = list()
...
async def _fetch_all_tasks_by_bodies(http_method, session, url, bodies_list, ids, params=None, headers=None, content_type='text'):
    tasks = list()
...
async def _fetch_all_by_urls(http_method, url_list, ids, params=None, body=None, headers=None, content_type='text'):
    global counter
    counter = 0
...
async def _fetch_all_by_params(http_method, url, params_list, ids, body=None, headers=None, content_type='text'):
    global counter
    counter = 0
...
async def _fetch_all_by_headers(http_method, url, headers_list, ids, params=None, body=None, content_type='text'):
    global counter
    counter = 0
    async with aiohttp.ClientSession() as session:
        print(f"Подключение к {url.split('//')[1].split('/')[0]}...")
...
async def _fetch_all_by_bodies(http_method, url, bodies_list, ids, params=None, headers=None, content_type='text'):
    global counter
    counter = 0
    async with aiohttp.ClientSession() as session:
        print(f"Подключение к {url.split('//')[1].split('/')[0]}...")
...
def by_urls(http_method, url_list, ids, params=None, body=None, headers=None, content_type='text'):
...
def by_params(http_method, url, params_list, ids, body=None, headers=None, content_type='text'):
    asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
    while (True):
...
def by_headers(http_method, url, headers_list, ids, params=None, body=None, content_type='text'):
    asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
    while (True):
...
def by_bodies(http_method, url, bodies_list, ids, params=None, headers=None, content_type='text'):
    asyncio.set_event_loop_policy(asyncio.WindowsSelectorEventLoopPolicy())
    while (True):
